  ...
  function getPost() {
    axios.get("/posts/" + params.Id).then((res) => {
      ...
      const postFormatted = {
        ...
        channelImage: post.channel.aviUrl,
        tag: post.tags,
        likes: post.likes,
        video: post.video,
      ...
      setCurrentContent(postFormatted);
      // const formattedData = res.data.posts.map((post) => {
      //   return {
      //     _id: post._id,
      //     title: post.title,
      //     channel: post.channel.name,
      ...
      <div className="main__content">
        <div className="main__content-left">
          ...
          <div className="main__content-left--video-info">
            ...
            <div className="main__content-left--video-info__icons">
              <div className="icon">
                ...
                <span>{currentContent.likes}K</span>
              </div>
              <div className="icon">
          ...
          <div className="main__content-left--video-description">
            <p className="description">{currentContent.details}</p>
            <a className="link" href={currentContent.github}>
              Github
            </a>
            {currentContent.link !== "" ? (
              <a className="link" href={currentContent.link}>
                Link to Site
              </a>
            ) : (
              ""
